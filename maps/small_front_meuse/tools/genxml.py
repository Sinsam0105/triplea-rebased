...
GAMEPLAY = '''  <gamePlay>
    ...
    <sequence>
      ...
      <step name="germanExploitMove" delegate="move" player="Germans" display="Exploitation">
        <stepProperty name="combatMove" value="true"/>
        <stepProperty name="exploitationMove" value="true"/>
      </step>
      <step name="germanExploitBattle" delegate="battle" player="Germans" display="Exploitation">
        <stepProperty name="exploitationBattle" value="true"/>
      </step>
      ...
      <step name="americanExploitMove" delegate="move" player="Americans" display="Exploitation">
        <stepProperty name="combatMove" value="true"/>
        <stepProperty name="exploitationMove" value="true"/>
      </step>
      <step name="americanExploitBattle" delegate="battle" player="Americans" display="Exploitation">
        <stepProperty name="exploitationBattle" value="true"/>
      </step>
